...
connect-ucs $dc
Get-UcsBlade | Select-Object ServerId,Model,AssignedToDn | Export-Csv -path "c:\users\$env:USERNAME\desktop\UCS_SERVER_Inventory.csv" -NoTypeInformation -UseCulture
disconnect-ucs
